...
void _ui_screen_change_clean(lv_obj_t ** target, lv_scr_load_anim_t fademode, int spd, int delay, void (*target_init)(void)) {
    lv_obj_t * act_scr = lv_scr_act(); // 获取当前屏幕
    lv_obj_clean(act_scr);            // 清理当前屏幕内容
